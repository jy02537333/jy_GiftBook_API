...
@Transactional
public class GroupmemberServiceImpl extends CommonServiceImpl implements GroupmemberServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(GroupmemberEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(GroupmemberEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(GroupmemberEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(GroupmemberEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,GroupmemberEntity t){
