...
@Service("membergiftmoneyService")
@Transactional
public class MembergiftmoneyServiceImpl extends CommonServiceImpl implements MembergiftmoneyServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(MembergiftmoneyEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(MembergiftmoneyEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	...
	private void doDelBus(MembergiftmoneyEntity t) throws Exception{
 	...
 	private Map<String,Object> populationMap(MembergiftmoneyEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,MembergiftmoneyEntity t){
