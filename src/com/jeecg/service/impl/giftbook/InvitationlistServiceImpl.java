...
@Transactional
public class InvitationlistServiceImpl extends CommonServiceImpl implements InvitationlistServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(InvitationlistEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(InvitationlistEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(InvitationlistEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(InvitationlistEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,InvitationlistEntity t){
