 ...
 */
@Controller
@RequestMapping("/truckRouteController")
public class TruckRouteController extends BaseController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(TruckRouteController.class);
	...
	public void datagrid(TruckRouteEntity truckRoute,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
