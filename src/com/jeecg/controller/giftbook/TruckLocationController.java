 ...
 */
@Controller
@RequestMapping("/truckLocationController")
public class TruckLocationController extends BaseController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(TruckLocationController.class);
	...
	public void datagrid(TruckLocationEntity truckLocation,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
