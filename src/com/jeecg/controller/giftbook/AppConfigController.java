 ...
 */
@Controller
@RequestMapping("/appConfigController")
public class AppConfigController extends BaseController {
	...
	public void datagrid(AppConfigEntity appConfig, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		dataGrid.setField("id,isShowCenter,createDate");
	...
	public AjaxJson importExcel(HttpServletRequest request, HttpServletResponse response) {
		...
		for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
			...
			try {
				List<AppConfigEntity> listAppConfigEntitys =(	List<AppConfigEntity>)
				ExcelImportUtil.importExcelByIs(file.getInputStream(),AppConfigEntity.class,params);
