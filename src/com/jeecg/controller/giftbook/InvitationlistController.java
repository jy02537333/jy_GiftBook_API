 ...
 */
@Controller
@RequestMapping("/invitationlistController")
public class InvitationlistController extends BaseController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(InvitationlistController.class);
	...
	public AjaxJson importExcel(HttpServletRequest request, HttpServletResponse response) {
		...
		for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
			...
			try {
				List<InvitationlistEntity> listInvitationlistEntitys =(List<InvitationlistEntity> ) ExcelImportUtil.importExcelByIs(file.getInputStream(),InvitationlistEntity.class,params);
