 ...
 */
@Entity
@Table(name = "app_config", schema = "")
@SuppressWarnings("serial")
public class AppConfigEntity implements java.io.Serializable {
	/**id*/
	private String id;
	/**createName*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  是否显示app中间金融中心
	 */
	@Column(name ="IS_SHOW_CENTER",nullable=true,length=1)
	public String getIsShowCenter(){
		return this.isShowCenter;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  是否显示app中间金融中心
	 */
	public void setIsShowCenter(String isShowCenter){
