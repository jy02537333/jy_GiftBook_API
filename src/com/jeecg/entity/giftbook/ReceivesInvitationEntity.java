 ...
 */
@Entity
@Table(name = "receives_invitation", schema = "")
@SuppressWarnings("serial")
public class ReceivesInvitationEntity implements java.io.Serializable {
	/**Id*/
	private String id;
	/**收礼类型*/
	 ...
	 */
	@Column(name ="RECEIVESTYPE",nullable=false,length=10)
