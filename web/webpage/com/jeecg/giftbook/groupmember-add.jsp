...
<head>
 ...
 <body>
	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="groupmemberController.do?doAdd" tiptype="1" >
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" id="con-wrapper1" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="gourpid" name="gourpid" type="text" class="form-control"  >
