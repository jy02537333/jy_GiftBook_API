...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="financialSupermarketController.do?doAdd" tiptype="1" >
				<input id="id" name="id" type="hidden" value="${financialSupermarketPage.id }">
		<fieldset class="step">
			<div class="form">
		      <label class="Validform_label">第三方公司名称:</label>
		     	 <input id="thirdpartyname" name="thirdpartyname" type="text" style="width: 150px" class="inputxt" >
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">第三方公司关键字:</label>
		     	 <input id="thirdpartycode" name="thirdpartycode" type="text" style="width: 150px" class="inputxt" >
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">第三方公司关键字2:</label>
		     	 <input id="thirdpartycode2" name="thirdpartycode2" type="text" style="width: 150px" class="inputxt" >
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">第三方地址:</label>
		     	 <input id="thirdpartyaddr" name="thirdpartyaddr" type="text" style="width: 150px" class="inputxt" >
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
			...
			<div class="form">
		      <label class="Validform_label">贷款额度:</label>
		     	 <input id="moneylimit" name="moneylimit" type="text" style="width: 150px" class="inputxt" >
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
        ...
        <div class="tab-content">
			...
			<div class="form">
		      <label class="Validform_label">贷款利息:</label>
		     	 <input id="moneyinterest" name="moneyinterest" type="text" style="width: 150px" class="inputxt" >
		      <span class="Validform_checktip"></span>
		    </div>
