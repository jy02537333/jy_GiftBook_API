/*global plupload */
/*global qiniu */
var imgBaseUrl= "http://images.libugj.cn/";
...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    if (res.url) {
        url = res.url;
        str = "<div><strong>地址:</strong><a href="+imgBaseUrl + res.url + " target='_blank' > " + res.url + "</a></div>"
       // +"<div class=hash><strong>Hash:</strong>" + res.hash + "</div>"
        ...
        str = "<div><strong>地址:</strong><a href=" +imgBaseUrl+ url + " target='_blank' > " + link + "</a></div>" 
        //+ "<div class=hash><strong>Hash:</strong>" + res.hash + "</div>"
        ;
    }
